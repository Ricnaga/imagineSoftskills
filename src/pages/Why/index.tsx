    ...
    return (
        ...
        <WhyAll>
            <p>
                ...
                Quanto maior soft skill do profissional, mais positivamente é afetado no ambiente corporativo e produtividade da equipe. Outro benefícios é maior preparação para o mercado de trabalho.
            </p>
            ...
            <ul id="points">
                ...
                <li>Foco</li>
                <li>Motivação</li>
                <li>Agilidade em adquirir cargos del idenraça</li>
            </ul>
        </WhyAll>
        </>
    )
